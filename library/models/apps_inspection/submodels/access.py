...
class InspectionApplicationPages(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Inspection - Application page'
        verbose_name_plural = 'Inspection - Application pages'
    def __str__(self):
        return '(%s) %s -- %s'%(self.app_code, self.page_code, self.name)

class InspectionApplicationPageConfig(models.Model):
    access_name     = models.CharField(max_length=200)
    page            = models.ForeignKey(InspectionApplicationPages, on_delete=models.CASCADE)
    description     = models.TextField(blank=True, null=True)
    ...
    class Meta:
        ...
        verbose_name        = 'Inspection - Application page config'
        verbose_name_plural = 'Inspection - Application pages config'
    def __str__(self):
        return '(%s) %s -- %s'%(self.page, self.access_name, self.description)

class InspectionAccessRightConfig(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Inspection - Access right'
        verbose_name_plural = 'Inspection - Access right'
    def __str__(self):
