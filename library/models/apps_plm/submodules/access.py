...
class PlmApplicationPages(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Plm - Application page'
        verbose_name_plural = 'Plm - Application pages'
    def __str__(self):
        return '(%s) %s -- %s'%(self.app_code, self.page_code, self.name)

class PlmApplicationPageConfig(models.Model):
    access_name     = models.CharField(max_length=200)
    page            = models.ForeignKey(PlmApplicationPages, on_delete=models.CASCADE)
    description     = models.TextField(blank=True, null=True)
    ...
    class Meta:
        ...
        verbose_name        = 'Plm - Application page config'
        verbose_name_plural = 'Plm - Application pages config'
    def __str__(self):
        return '(%s) %s -- %s'%(self.page, self.access_name, self.description)

class PlmAccessRightConfig(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Plm - Access right'
        verbose_name_plural = 'Plm - Access right'
    def __str__(self):
