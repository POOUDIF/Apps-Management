...
class DmsApplicationPages(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Dms - Application page'
        verbose_name_plural = 'Dms - Application pages'
    def __str__(self):
        return '(%s) %s -- %s'%(self.app_code, self.page_code, self.name)

class DmsApplicationPageConfig(models.Model):
    access_name     = models.CharField(max_length=200)
    page            = models.ForeignKey(DmsApplicationPages, on_delete=models.CASCADE)
    description     = models.TextField(blank=True, null=True)
    ...
    class Meta:
        ...
        verbose_name        = 'Dms - Application page config'
        verbose_name_plural = 'Dms - Application pages config'
    def __str__(self):
        return '(%s) %s -- %s'%(self.page, self.access_name, self.description)

class DmsAccessRightConfig(models.Model):
    ...
    class Meta:
        ...
        verbose_name        = 'Dms - Access right'
        verbose_name_plural = 'Dms - Access right'
    def __str__(self):
